                ...
                try {
                    ...
                    if (typeof options !== "undefined") {
                        if (!Array.isArray(options)) {
                            ...
                            if (options.length > 25) logInvalidate("ERROR", `'${name}' (${cmdPath}): command.options more than 25 options`);
                    ...
                    if (typeof permissions !== "undefined") {
                        if (!Array.isArray(permissions)) {
                            ...
                            if (permissions.length > 10) logInvalidate("ERROR", `'${name}' (${cmdPath}): command.permissions more than 10 overwrites`);
                            else {
    ...
    if (typeof subcommand.type === "undefined") logInvalidate("ERROR", `'${name}' (${cmdPath}): ${path} missing type`);
        ...
        if (typeof subcommand.options !== "undefined") {
            if (!Array.isArray(subcommand.options)) {
                ...
                if (subcommand.length > 25) logInvalidate("ERROR", `'${name}' (${cmdPath}): ${path}.options more than 25 options`);
