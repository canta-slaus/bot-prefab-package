...
module.exports = {
    ...
    run: async () => {
        ...
        const allEvents = [
            { title: "apiRequest", value: ["api.apiRequest", ["request", "import('discord.js').APIRequest"]], description: "Emitted before every API request. This event can emit several times for the same request, e.g. when hitting a rate limit." },
            { title: "apiResponse", value: ["api.apiResponse", ["request", "import('discord.js').APIRequest"], ["response", "Request"]], description: "Emitted after every API request has recevied a response. This event does not necessarily correlate to completion of the request, e.g. when hitting a rate limit." },
            ...
            { title: "guildScheduledEventCreate", value: ["guild.guildScheduledEventCreate", ["guildScheduledEvent", "import('discord.js').GuildScheduledEvent"]], description: "Emitted whenever a guild scheduled event is created." },
            { title: "guildScheduledEventDelete", value: ["guild.guildScheduledEventDelete", ["guildScheduledEvent", "import('discord.js').GuildScheduledEvent"]], description: "Emitted whenever a guild scheduled event is deleted." },
            { title: "guildScheduledEventUpdate", value: ["guild.guildScheduledEventUpdate", ["oldGuildScheduledEvent", "import('discord.js').GuildScheduledEvent"], ["newGuildScheduledEvent", "import('discord.js').GuildScheduledEvent"]], description: "Emitted whenever a guild scheduled event gets updated." },
            { title: "guildScheduledEventUserAdd", value: ["guild.guildScheduledEventUserAdd", ["guildScheduledEvent", "import('discord.js').GuildScheduledEvent"], ["user", "import('discord.js').User"]], description: "Emitted whenever a user subscribes to a guild scheduled event." },
            { title: "guildScheduledEventUserRemove", value: ["guild.guildScheduledEventUserRemove", ["guildScheduledEvent", "import('discord.js').GuildScheduledEvent"], ["user", "import('discord.js').User"]], description: "Emitted whenever a user unsubscribes from a guild scheduled event." },
